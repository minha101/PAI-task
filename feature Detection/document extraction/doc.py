...
if __name__ == '__main__':
    ...
    img = cv2.imread(r'C:\Users\Lenovo L380 A&I\OneDrive\Desktop\semester 4\sir rasikh\open\feature Detection\document extraction\untitled-311.png')
      
    # 3-d to 2-d conversion
    img_gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
     
    # Field templates
    template_add = cv2.imread(r'C:\Users\Lenovo L380 A&I\OneDrive\Desktop\semester 4\sir rasikh\open\feature Detection\document extraction\doc_address.png', 0)
    template_prev = cv2.imread(r'C:\Users\Lenovo L380 A&I\OneDrive\Desktop\semester 4\sir rasikh\open\feature Detection\document extraction\doc_prev_policy.png', 0)
